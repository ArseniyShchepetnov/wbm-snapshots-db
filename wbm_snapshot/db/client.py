...
class DbClient:
    ...
    def __init__(self,
        ...
        self._client: pymongo.MongoClient = pymongo.MongoClient(connection)
...
class SnapshotCollectionClient:
    ...
    def cursor2snapshots(self, cursor) -> List[Snapshot]:
        ...
        result = [self.document2snapshot(item) for item in cursor]
        return result
    ...
    def all_documents(self, fields: Optional[Dict[str, Any]] = None) \
            -> pymongo.cursor.Cursor:
